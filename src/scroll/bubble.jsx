...
const heigth_canvas = 160;
export default class Bubble extends React.Component {
  constructor() {
    super();
    this.canvas = null;
    this.ratio = window.devicePixelRatio;
    this.width = width_canvas * this.ratio;
    this.height = heigth_canvas * this.ratio;
    ...
    return (
      <div>
        <canvas
          ...
          style={{
            height: heigth_canvas / this.ratio,
            width: width_canvas / this.ratio
          }}
        />
      </div>
    );
